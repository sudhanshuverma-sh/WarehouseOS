  ...
  return (
    <span className="relative inline-flex">
      <button
        ...
        className={`ml-1 inline-flex items-center justify-center w-5 h-5 rounded transition cursor-pointer ${
          isActive
      ...
      {open && (
        <>
          ...
          <div
            className="absolute left-0 top-6 z-50 w-64 bg-white border border-slate-200 rounded-xl shadow-lg overflow-hidden"
